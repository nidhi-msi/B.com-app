...
export default function AnswerGuide() {
  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      ...
      {/* Hero Header */}
      <div 
        className="p-6 sm:p-8 rounded-3xl border transition-colors duration-300 shadow-lg"
      ...
      >
        ...
        <p className="text-xs sm:text-sm max-w-3xl leading-relaxed mt-2" style={{ color: 'var(--text-muted)' }}>
      ...
      {/* Guide Sub-Tabs Navigation Bar */}
      <div 
        className="p-2 rounded-2xl border flex flex-wrap items-center gap-1.5 shadow-sm"
        style={{ backgroundColor: 'var(--bg-card)', borderColor: 'var(--border-color)' }}
      >
        {guideTabs.map(tab => {
          const Icon = tab.icon;
          ...
          return (
            <button
              ...
              className="flex-1 min-w-[150px] sm:min-w-[180px] p-2.5 rounded-xl text-xs font-bold transition-all flex items-center justify-center gap-2 border"
              style={{
            ...
            >
              ...
              <div className="text-left">
                ...
                <p className={`text-[10px] font-normal leading-tight ${isTabActive ? 'text-white/80' : 'opacity-70'}`}>
                  {tab.desc}
                </p>
              </div>
            </button>
        ...
        <div className="space-y-6 animate-fadeIn">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {ANSWER_GUIDE_DATA.fourBlockFormula.map((blk) => (
              ...
              >
                <div 
                  className="w-9 h-9 rounded-xl border flex items-center justify-center font-mono font-bold text-sm"
      ...
      {activeGuideTab === 'modelAnswers' && (
        <div 
          className="p-6 sm:p-8 rounded-3xl border space-y-6 animate-fadeIn"
          style={{ backgroundColor: 'var(--bg-card)', borderColor: 'var(--border-color)' }}
        >
          <div>
            <span 
      ...
      {activeGuideTab === 'checklist' && (
        <div 
          className="p-6 sm:p-8 rounded-3xl border animate-fadeIn"
          style={{ backgroundColor: 'var(--bg-card)', borderColor: 'var(--border-color)' }}
        >
          ...
          <p className="text-xs mb-6" style={{ color: 'var(--text-muted)' }}>Essential rules every IGNOU B.Com student must follow inside the examination hall.</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
            {ANSWER_GUIDE_DATA.examWritingChecklist.map((item, idx) => (
              <div 
                ...
                style={{ backgroundColor: 'var(--bg-input)', borderColor: 'var(--border-color)', color: 'var(--text-main)' }}
              >
                <span className="w-6 h-6 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-600 dark:text-emerald-400 flex items-center justify-center font-bold text-xs shrink-0 mt-0.5">
                  ✓
                </span>
